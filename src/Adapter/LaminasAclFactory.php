            ...
            if (is_array($resources)) {
                foreach ($resources as $resource => $privileges) {
                    if (is_numeric($resource)) {
                        try {
                            if (is_array($privileges) && array_key_exists('assertion', $privileges)) {
                                $assertion = $privileges['assertion'];
                                unset($privileges['assertion']);
                                $acl->{$type}($role, $privileges, null, $assertion);
                            } else {
